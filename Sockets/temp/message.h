...
namespace http {
    ...
    public:
        ...
        inline const header_t& header() const noexcept
        { return m_header_; }
    ...
    public:
        ...
        message(method_token method, message_traits::target target,
            transfer_encoding_token data);
        message(std::string method, std::string target, std::string data);
        message(method_token method, message_traits::target target, std::string data);
        ...
        message_traits::message_type type() const noexcept;
        
        const std::vector<header_t>& headers() const noexcept;
        void headers(std::vector<header_t> list);
