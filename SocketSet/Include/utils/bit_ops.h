...
namespace internal {
    ...
    inline void
    to_big_endian_16(uint16_t& value)
    {
    ...
    inline void
    to_little_endian_16(uint16_t& value)
    {
    ...
    inline void
    to_big_endian_32(uint32_t& value)
    {
    #if defined LITTLE_ENDIAN
    ...
    inline void
    to_little_endian_32(uint32_t& value)
    {
    #if defined BIG_ENDIAN
        value = byte_swap_32(value);
    #else
    ...
    inline void
    to_big_endian_64(uint64_t& value)
    {
    #if defined LITTLE_ENDIAN
    ...
    inline void
    to_little_endian_64(uint64_t& value)
    {
    #if defined BIG_ENDIAN
        value = byte_swap_64(value);
    #else
